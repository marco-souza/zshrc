...
# ======================
  ...
  # Plugins
    ...
    # download kube-aliases
    KUBE_ALIASES_PLUGINS=$ZSH_PLUGINS_HOME/kube-aliases
    if [ ! -e $KUBE_ALIASES_PLUGINS ]; then
      git clone git@github.com:Dbz/kube-aliases.git $KUBE_ALIASES_PLUGINS
    fi
